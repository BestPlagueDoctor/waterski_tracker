...
def load_video():
    ...
    mapfile = "./vid_src/map.mp4"
    pitch_yaw_roll_file = "./vid_src/pitch_yaw_roll.mp4"
    speed_file = "./vid_src/speed.mp4"
...
skip_plus_5 = tk.Button(seek_bar, text="+5s", command=lambda:skip(5))
skip_minus_5 = tk.Button(seek_bar, text="-5s", command=lambda:skip(-5))
...
pitch_yaw_roll_player.set_size((960, 520))
